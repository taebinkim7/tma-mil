...
mkdir -p /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$train_dir"_normalized_"$train_dir"_svd/mil/he
...
/datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$train_dir"_normalized_"$train_dir"_svd

mkdir -p /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$test_dir"_normalized_"$train_dir"_svd/mil/he
...
/datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$test_dir"_normalized_"$train_dir"_svd

python /datastore/lbcfs/labs/smarronlab/tkim/projects/stain-mcmc/scripts/normalize_train_test_images.py \
--train-input-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$train_dir"/images/he \
--train-output-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$train_dir"_normalized_"$train_dir"_svd/images/he \
--test-input-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$test_dir"/images/he \
--test-output-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$test_dir"_normalized_"$train_dir"_svd/images/he \
--extractor-type svd \
--n-jobs 50
