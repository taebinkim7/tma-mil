...
--train-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$TRAIN_DIR"_san_"$TRAIN_DIR"_svd_"$CASE"/mil/he \
--test-dir /datastore/lbcfs/labs/smarronlab/tkim/data/tma_"$TEST_DIR"_san_"$TRAIN_DIR"_svd_"$CASE"/mil/he \
