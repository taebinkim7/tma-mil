...
if __name__ == '__main__':
    ...
    train_feats = util.load_feats(train_dir, train_sample_images, model_name, layer, pool_size, train_instance_size, train_instance_stride, mi_type)
    test_feats = util.load_feats(test_dir, test_sample_images, model_name, layer, pool_size, test_instance_size, test_instance_stride, mi_type)
    ...
    for c, cat_name in enumerate(cats):
        ...
        for f in range(cv_folds):
            ...
            model_path = train_dir + '_' + mi_type + '_' + classifier + '_' + cat_name + '_i' \
